...
/// MENU PRINICIPAL, PRINTEA LAS OPCIONES DEL INICIO DEL PROGRAMA Y RETORNA LA OPCION ELEGIDA.
int MainMenu(){
...
/// PRINTEA LAS OPCIONES DEL MENU MODIFICAR Y MEDIANTE UN SWITCH, PERMITE MODIFICAR DATOS. RETORNA 1 SI SE CUMPLIO CON LA MODIFICACION.
...
/// PRINTEA LAS OPCIONES DEL MENU DE LISTAR, RECIBE LA ESTRUCTURA PASAJERO PARA PODER PASARSELA A OTRAS FUNCIONES PARA HACER LOS LISTADOS.
